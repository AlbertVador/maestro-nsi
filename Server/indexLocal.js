...
const express = require("express"); // Framework pour les applications web en Node.js
...
const device = require('express-device'); // Middleware pour détecter le type de dispositif
...
const ws = require("ws"); // Pour les WebSockets
const fs = require("fs"); // Pour gérer les fichiers système
